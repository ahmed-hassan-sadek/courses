              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?= $row['price'];?></td>
                    <td><?= $row['catName'];?></td>
                    <td><img src="../upload/courses/<?= $row['image'];?>" width="100px" height="100px"></td>
                    <td><?=$row['body'];?></td>
                    <td><a  class="btn btn-success" href="../forms/update-course.php?id=<?=$row['courseId']?>">Update</a></td>
                    <td>
                      <form action="../../../backend/course.php" method = "POST" enctype = "multipart/form-data">
                        <input type="hidden" name="delete_id" value = "<?= $row['courseId'];?>">
